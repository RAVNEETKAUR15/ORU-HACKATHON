...
with st.sidebar:
    ...
    **Precision:** 81.1%  
    ...
    [📄 Phase 1 Analysis](https://github.com/RAVNEETKAUR15/ipl-dots-to-damage)
    
    [📂 Phase 2 Prediction](https://github.com/RAVNEETKAUR15/ipl_phase2_chase_strategy) 
    """)
...
<div class="main-header">
    ...
    <span class="badge">Phase 2 — ORU IPL Analytics Hackathon</span>
</div>
""", unsafe_allow_html=True)
