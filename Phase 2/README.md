...
## Dataset
- **Source:** IPL ball-by-ball data (2007–2025) from Cricsheet, via the [ORU Hackathon](https://github.com/SahilGogna/IPL-Hackathon)
...
*Built for the [ORU IPL Analytics Hackathon](https://github.com/SahilGogna/IPL-Hackathon) - Phase 2*

*Phase 1 analysis: [ipl-dots-to-damage](https://github.com/RAVNEETKAUR15/ipl-dots-to-damage)*
