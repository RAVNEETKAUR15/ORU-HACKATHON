# 🏏 ORU IPL Analytics Hackathon — Winner
...
- **Source:** IPL ball-by-ball data (2008–2025) from [Cricsheet](https://cricsheet.org/), provided via the [ORU Hackathon](https://github.com/SahilGogna/IPL-Hackathon)
